...
<html lang="en">
<head>
    <link rel="stylesheet" href="../CSS/AdminListOfForDelivery.css">
    <meta charset="UTF-8">
                ...
                <table id="dataTable">
                    <thead>
                        <tr>
                            ...
                            <th class="sortable" data-sort="full_name">Customer Info</th>
                    ...
                    <tbody>
                        <?php
                            ...
                            if(isset($_GET['sort']))
                            {
                                ...
                                {
                                    $sql = "SELECT orders.order_id, orders.user_id, orders.order_status, orders.processed_by,  users.full_name, product_items.product_name,
                                    ...
                                    WHERE orders.order_status = 3 ORDER BY $col; ";
                                }
                                ...
                                elseif(substr($_GET['sort'], 0, 3) == 'des')
                                {
                                    ...
                                    JOIN users ON order_items.user_id = users.user_id
                                    JOIN product_items ON order_items.product_id = product_items.product_id
                                    WHERE orders.order_status = 3 ORDER BY $col DESC; ";
                                }
